  ...
  const uniforms = useMemo(
    () => ({
      ...
      uColor: {
        ...
        value: new Color('rgb(221, 221, 221)'),
...
export function Arm() {
  const { scene: arm1 } = useGLTF('/assets/models/geographic/mount_everest_himalayan.glb')
  const { scene: arm2 } = useGLTF('/assets/models/geographic/mount_everest.glb')
