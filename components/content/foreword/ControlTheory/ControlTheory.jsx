...
import { Elephants } from './Paintings'
import { DigitalOil } from './Paintings'
import { NuerembergChronicle } from './Paintings'
import { Newton } from './Paintings'
...
function ElephantsSection({ className }) {
  const el = useRef()
  return (
    <section className={`ElephantsSection ${className}`}>
      <div>
