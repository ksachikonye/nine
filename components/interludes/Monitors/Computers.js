...
export function Instances({ children, ...props }) {
  const { nodes } = useGLTF('/assets/models/devices/computers_1-transformed.glb')
...
export function Computers(props) {
  const { nodes: n, materials: m } = useGLTF('/assets/models/devices/computers_1-transformed.glb')
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <Video src='https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/silent.mp4' frame="Object_209" panel="Object_210" y={5} position={[-1.43, 2.5, -1.8]} rotation={[0, 1, 0]} />
      <Video src='https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/silent.mp4' invert frame="Object_212" panel="Object_213" x={-5} y={5} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
      <Video src='https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/site-intro.mp4' frame="Object_215" panel="Object_216" position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} />
      ...
      <Video src='https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/1987WACMen-100m.mp4' frame="Object_224" panel="Object_225" position={[-3.9, 4.29, -2.64]} rotation={[0, 0.54, 0]} />
      <Video src='https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/silent.mp4' frame="Object_227" panel="Object_228" position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
      <Video src='https://raw.githubusercontent.com/ksachikonye/hzevo-server/main/media/mp4/site-intro.mp4' frame="Object_230" panel="Object_231" position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
...
function Screen({ frame, panel, children, ...props }) {
  const { nodes, materials } = useGLTF('/assets/models/devices/computers_1-transformed.glb')
  return (
    <group {...props}>
...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <Text font="/assets/fonts/Inter-Medium.woff" position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : '#35c19f'}>
        Merovingian.
      </Text>
    </Screen>
  )
